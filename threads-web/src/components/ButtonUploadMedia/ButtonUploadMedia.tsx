import { uploadImage, uploadVideo } from "@/apis/media"
import React from "react"

interface ButtonUploadMediaProps {
...
export default function ButtonUploadMedia({
  ...
  return (
    <>
      <button type='button' onClick={handleButtonClick} className='p-2.5 rounded-[0.75rem] group bg-neutral2-1'>
