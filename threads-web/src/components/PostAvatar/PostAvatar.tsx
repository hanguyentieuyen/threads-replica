...
export default function PostAvatar({ user, postedTime }: AvatarProps) {
  const [open, setOpen] = useState(false)
  return (
    <div className='flex items-center space-x-3'>
      <div className='relative'>
        <img className='w-10 h-10 rounded-full border-2 border-pink-500' src={user?.avatar} alt='User avatar' />
